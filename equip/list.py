...
ECList_Third_english = [
    [
        ["Scholar Robe", "Cleric Robe", "Mage Robe"],
        ["Scholar Cowl", "Cleric Cowl", "Mage Cowl"],
        ["Scholar Sandals", "Cleric Sandals", "Mage Sandals"],
        ["Mercenary Jacket", "Hunter Jacket", "Assassin Jacket"],
        ["Mercenary Hood", "Hunter Hood", "Assassin Hood"],
        ["Mercenary Shoes", "Hunter Shoes", "Assassin Shoes"],
        ["Soldier Armor", "Knight Armor", "Guardian Armor"],
        ["Soldier Helmet", "Knight Helmet", "Guardian Helmet"],
        ["Soldier Boots", "Knight Boots", "Guardian Boots"]
    ],
    [
        ["Arcane Staff", "Cursed Staff", "Fire Staff"],
        ["Great Arcane Staff", "Great Cursed Staff", "Great Fire Staff"],
        ["Enigmatic Staff", "Demonic Staff", "Infernal Staff"],
        ["Frost Staff", "Holy Staff", "Nature Staff"],
        ["Great Frost Staff", "Great Holy Staff", "Great Nature Staff"],
        ["Glacial Staff", "Divine Staff", "Wild Staff"]
    ],
    [
        ["Battleaxe", "Dagger", "Hammer"],
        ["Greataxe", "Dagger Pair", "Polehammer"],
        ["Halberd", "Claws", "Great Hammer"],
        ["Brawler Gloves", "Mace", "Quarterstaff"],
        ["Battle Bracers", "Heavy Mace", "Iron-clad Staff"],
        ["Spiked Gauntlets", "Morning Star", "Double Bladed"],
        ["Spear", "Pike", "Glaive"],
